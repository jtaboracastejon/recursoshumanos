    ...
    <div class="row sales layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <span wire:click="$set('pageTitle', 'Lista de Porciones')">
                <button wire:click="$set('show', 'ver')" class="btn btn-primary mb-2 mr-2"><i class="fa-solid fa-eye"></i> Ver</button>
            </span>
            @if ($show=='editar')
            ...
            <span wire:click="$set('pageTitle', 'Crear nuevo registro')">
                <button wire:click="$set('show', 'agregar')" class="btn btn-success mb-2 mr-2"><i class="fa-solid fa-file-plus"></i> Agregar</button>
            </span>
            @endif
        </div>
        @if ($show == 'agregar')
